...
class TabFilterView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(
        ...
        builder: (homeController) {
          return Column(
            children: [
              homeController.courseTabList !=null?SizedBox(
                height: 50,
                width: Get.width,
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () =>
                          homeController.handleTabListTap(index: index,courseId:homeController.courseTabList!.batches[index].catId ),
                      child: Container(
                        ...
                        child: AppHelperWidget().appText(
                            text: homeController.courseTabList!.batches[index].batchName,
                            fontSize: 18,
  ...
  Widget _courseGridView() {
    return GetBuilder<HomeController>(
      //init: HomeController(),
      builder: (controller) {
        return controller.allTabCourseCourseModal!=null?GridView.builder(
                ...
                child: Column(
                  children: [
                    AppHelperWidget().imageBuilder(
                        imagePath:controller.allTabCourseCourseModal!.batches[index].batchImageUrl,
                        isAssetImage: false,
                        height: 100,
                        width: Get.width,
                        borderRadius: 10),
                          ...
                          child: Column(
                            children: [
                              AppHelperWidget().appText(
                                  ...
                                  text:controller.allTabCourseCourseModal!.batches[index].batchName,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  AppHelperWidget().appText(
                                      ...
                                      fontSize: 10,
                                      text: controller.allTabCourseCourseModal!.batches[index].noOfStudent,
