...
class MeetingWidget extends StatefulWidget {
 ...
 final String appSecretKey;
  ...
  const MeetingWidget({
    ...
    required this.appSecretKey,
    required this.meetId,
    required this.meetPassword,
  }) : super(key: key);
...
@override
  void initState() {
  meetingIdController.text=widget.meetId;
  meetingPasswordController.text=widget.meetPassword;
  Future.delayed(Duration.zero).then((value) => joinMeeting(context));
    super.initState();
  }
